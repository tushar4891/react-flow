...
export const TimerModal = ({ onWaitInputSelect }) => {
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body " style={{ marginTop: "-15px" }}>
            ...
            {/* 2nd row */}
            <div className=" gap-5 mt-4 d-flex flex-row justify-content-center align-items-center">
              {/* top left */}
              <div
              ...
              >
                <div className="d-flex gap-3 px-3">
                  ...
                  <div>
                    <p style={{ fontWeight: "900" }}> Wait </p>
                    <p>Add a delay between blocks</p>
                  </div>
                </div>
                {<WaitModal onWaitInputSelect={onWaitInputSelect} />}
              </div>
              {/* top right */}
              <div className="col-lg-5 shadow-4 pt-3 hover-square">
                <div className="d-flex gap-3 px-3">
            ...
            {/* 3rd row */}
            <div className="pt-5 mx-5 pb-4 gap-5 d-flex flex-row ">
              {/* top left */}
